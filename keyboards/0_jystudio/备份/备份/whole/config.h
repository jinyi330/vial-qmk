...
/* key matrix pins */
#define MATRIX_ROW_PINS { A8, A9, B12, B13}
#define MATRIX_COL_PINS { A3,A4,A5,A1,A2,A15,B3,B15,B14,B8 }
...
#define VIAL_KEYBOARD_UID {0x07, 0x70, 0x3E, 0x60, 0x00, 0x62, 0xA3, 0xD4}
...
// 摇杆配置
#define ANALOG_JOYSTICK_X_AXIS_PIN A6
